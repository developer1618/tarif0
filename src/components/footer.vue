  ...
  <footer class="relative isolate bg-gray-900">
    <div class="mx-auto max-w-7xl py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
      ...
      <div class="mt-8 md:order-1 md:mt-0">
        <p class="text-center text-xs leading-5 text-gray-500">&copy; 2023 Livo, Все права защищены.</p>
      </div>
    </div>
  </footer>
</template>
...
const navigation = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/livo.dev/',
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/livo.dev/',
    icon: defineComponent({
      render: () =>
        h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
          h('path', {
